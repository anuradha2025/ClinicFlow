                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    HStack(spacing: 10) {
                        ...
                        Button("No Schedule") {}
                            ...
                            .frame(maxWidth: .infinity)
                            .padding(.vertical, 10)
                            .overlay(RoundedRectangle(cornerRadius: 10).stroke(Color.cfDanger, lineWidth: 1))
                    }
                }
                .padding()
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        VStack(spacing: 0) {
                            ...
                            ForEach(appointment.queueEntries) { entry in
                                HStack {
                                    Text("\(entry.id)").font(.subheadline.bold()).frame(width: 30)
                                    Text(entry.time).font(.caption).foregroundColor(.cfTextSecondary)
                                    Spacer()
                ...
                VStack(spacing: 10) {
                    NavigationLink(destination: BookAppointmentView(doctor: appointment.doctor)) {
                        Text("Reschedule Appointment")
                            ...
                            .frame(maxWidth: .infinity)
                            .padding(.vertical, 14)
                            .overlay(RoundedRectangle(cornerRadius: 12).stroke(Color.cfPrimary, lineWidth: 1))
                    }
                    ...
                    Button {
                        ...
                        Text("Cancel Appointment")
                            ...
                            .frame(maxWidth: .infinity)
                            .padding(.vertical, 14)
                            .overlay(RoundedRectangle(cornerRadius: 12).stroke(Color.cfDanger, lineWidth: 1))
                    }
                }
                .padding(.horizontal)
            }
