            ...
            VStack(spacing: 0) {
                ...
                ScrollView(.vertical, showsIndicators: false) {
                    VStack(spacing: 16) {
                        ...
                        CFCard(padding: 12) {
                            HStack(spacing: 10) {
                                CardTypeTab(name: "VISA",       icon: "v.circle.fill",  isSelected: cardType == 0) { cardType = 0 }
                                CardTypeTab(name: "Mastercard", icon: "m.circle.fill",  isSelected: cardType == 1) { cardType = 1 }
                            }
                        }
                        ...
                        ZStack {
                            ...
                            // Decorative circles
                            Circle().fill(Color.white.opacity(0.08)).frame(width: 180, height: 180).offset(x: 100, y: -60)
                            Circle().fill(Color.white.opacity(0.05)).frame(width: 120, height: 120).offset(x: -80, y: 60)
